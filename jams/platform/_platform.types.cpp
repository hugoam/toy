...
namespace mud
{
    ...
    template <> _PLATFORM_EXPORT Type& type<mud::ComponentHandle<Bullet>>() { static Type ty("ComponentHandle<Bullet>", sizeof(mud::ComponentHandle<Bullet>)); return ty; }
    template <> _PLATFORM_EXPORT Type& type<mud::ComponentHandle<Crate>>() { static Type ty("ComponentHandle<Crate>", sizeof(mud::ComponentHandle<Crate>)); return ty; }
    template <> _PLATFORM_EXPORT Type& type<mud::ComponentHandle<Human>>() { static Type ty("ComponentHandle<Human>", sizeof(mud::ComponentHandle<Human>)); return ty; }
    template <> _PLATFORM_EXPORT Type& type<mud::ComponentHandle<Lamp>>() { static Type ty("ComponentHandle<Lamp>", sizeof(mud::ComponentHandle<Lamp>)); return ty; }
