...
namespace mud
{
    ...
    export_ template struct _GODOT_EXPORT Typed<vector<Aim*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<Bullet*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<Crate*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<Human*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<Lamp*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<Player*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<Stance*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<WorldBlock*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<mud::ComponentHandle<Bullet>*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<mud::ComponentHandle<Crate>*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<mud::ComponentHandle<Human>*>>;
    export_ template struct _GODOT_EXPORT Typed<vector<mud::ComponentHandle<Lamp>*>>;
}
