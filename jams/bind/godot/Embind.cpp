...
EMSCRIPTEN_BINDINGS(_godot)
{
    ...
    class_<Player>("Player")
        ;
    class_<WorldBlock>("WorldBlock")
        .constructor<>()
        .constructor<toy::HSpatial, toy::HWorldPage, toy::HNavblock, const mud::vec3&>()
        .property("extents", &WorldBlock::m_extents)
        ;
