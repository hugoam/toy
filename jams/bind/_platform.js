...
function TileWorld(a0, a1) {
    ensureCache.prepare();
    this.ptr = _TileWorld__construct_2(ensureString(/*name*/a0), /*job_system*/a1.ptr); this.type = TileWorld; getCache(TileWorld)[this.ptr] = this;
};
...
Object.defineProperty(TileWorld.prototype, "world", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_TileWorld__get_world(self), World);
    }});
Object.defineProperty(TileWorld.prototype, "bullet_world", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_TileWorld__get_bullet_world(self), BulletWorld);
    }});
Object.defineProperty(TileWorld.prototype, "navmesh", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_TileWorld__get_navmesh(self), Navmesh);
    }});
