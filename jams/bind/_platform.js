...
function TileWorld(a0, a1) {
    ensureCache.prepare();
    this.__ptr = _TileWorld__construct_2(ensureString(/*name*/a0), /*job_system*/a1.__ptr); this.__type = TileWorld.__type; getCache(TileWorld)[this.__ptr] = this;
};
...
(function() {
    function setup() {
        ...
        TileWorld.__type = _TileWorld__type();
        // Faction
