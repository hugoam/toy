...
extern "C" {
	...
	WorldBlock* DECL WorldBlock__construct_0() {
		return new WorldBlock();
	}
	WorldBlock* DECL WorldBlock__construct_4(toy::HSpatial* spatial, toy::HWorldPage* world_page, toy::HNavblock* navblock, const two::vec3* extents) {
