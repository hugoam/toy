...
function Boid() {
    var self = this.ptr;
    this.ptr = _Boid_Boid_0(self); getCache(Boid)[this.ptr] = this;
};
...
Boid.prototype["__destroy__"] = Boid.prototype.__destroy__ = function() {
    var self = this.ptr;
    _Boid___destroy__(self);
};
// BoidObstacle
function BoidObstacle() {
    var self = this.ptr;
    this.ptr = _BoidObstacle_BoidObstacle_0(self); getCache(BoidObstacle)[this.ptr] = this;
};
...
BoidObstacle.prototype["__destroy__"] = BoidObstacle.prototype.__destroy__ = function() {
    var self = this.ptr;
    _BoidObstacle___destroy__(self);
};
// BoidTarget
function BoidTarget() {
    var self = this.ptr;
    this.ptr = _BoidTarget_BoidTarget_0(self); getCache(BoidTarget)[this.ptr] = this;
};
...
BoidTarget.prototype["__destroy__"] = BoidTarget.prototype.__destroy__ = function() {
    var self = this.ptr;
    _BoidTarget___destroy__(self);
};
// Heading
function Heading() {
    var self = this.ptr;
    this.ptr = _Heading_Heading_0(self); getCache(Heading)[this.ptr] = this;
};
...
Heading.prototype["__destroy__"] = Heading.prototype.__destroy__ = function() {
    var self = this.ptr;
    _Heading___destroy__(self);
};
// MoveForward
function MoveForward() {
    var self = this.ptr;
    this.ptr = _MoveForward_MoveForward_0(self); getCache(MoveForward)[this.ptr] = this;
};
...
MoveForward.prototype["__destroy__"] = MoveForward.prototype.__destroy__ = function() {
    var self = this.ptr;
    _MoveForward___destroy__(self);
};
// MoveSpeed
function MoveSpeed() {
    var self = this.ptr;
    this.ptr = _MoveSpeed_MoveSpeed_0(self); getCache(MoveSpeed)[this.ptr] = this;
};
...
function Position() {
    var self = this.ptr;
    this.ptr = _Position_Position_0(self); getCache(Position)[this.ptr] = this;
};
...
Position.prototype["__destroy__"] = Position.prototype.__destroy__ = function() {
    var self = this.ptr;
    _Position___destroy__(self);
};
// Rotation
function Rotation() {
    var self = this.ptr;
    this.ptr = _Rotation_Rotation_0(self); getCache(Rotation)[this.ptr] = this;
};
...
Rotation.prototype["__destroy__"] = Rotation.prototype.__destroy__ = function() {
    var self = this.ptr;
    _Rotation___destroy__(self);
};
// Transform4
function Transform4() {
    var self = this.ptr;
    this.ptr = _Transform4_Transform4_0(self); getCache(Transform4)[this.ptr] = this;
};
