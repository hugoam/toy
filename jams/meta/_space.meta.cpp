...
void mud_ComponentHandle_Fleet__construct_0(void* ref, span<void*> args) { UNUSED(args); new(stl::placeholder(), ref) mud::ComponentHandle<Fleet>(  ); }
void mud_ComponentHandle_Fleet__copy_construct(void* ref, void* other) { new(stl::placeholder(), ref) mud::ComponentHandle<Fleet>((*static_cast<mud::ComponentHandle<Fleet>*>(other))); }
void mud_ComponentHandle_Galaxy__construct_0(void* ref, span<void*> args) { UNUSED(args); new(stl::placeholder(), ref) mud::ComponentHandle<Galaxy>(  ); }
void mud_ComponentHandle_Galaxy__copy_construct(void* ref, void* other) { new(stl::placeholder(), ref) mud::ComponentHandle<Galaxy>((*static_cast<mud::ComponentHandle<Galaxy>*>(other))); }
void mud_ComponentHandle_Star__construct_0(void* ref, span<void*> args) { UNUSED(args); new(stl::placeholder(), ref) mud::ComponentHandle<Star>(  ); }
void mud_ComponentHandle_Star__copy_construct(void* ref, void* other) { new(stl::placeholder(), ref) mud::ComponentHandle<Star>((*static_cast<mud::ComponentHandle<Star>*>(other))); }
...
void Fleet__construct_1(void* ref, span<void*> args) { new(stl::placeholder(), ref) Fleet( *static_cast<toy::HSpatial*>(args[0]), *static_cast<Galaxy*>(args[1]), *static_cast<Commander*>(args[2]), *static_cast<mud::uvec2*>(args[3]), *static_cast<stl::string*>(args[4]) ); }
void Fleet_order_jump(void* object, span<void*> args, void*& result) { UNUSED(result); (*static_cast<Fleet*>(object)).order_jump(*static_cast<mud::uvec2*>(args[0]), *static_cast<FleetStance*>(args[1])); }
...
void Galaxy__construct_1(void* ref, span<void*> args) { new(stl::placeholder(), ref) Galaxy( *static_cast<toy::HSpatial*>(args[0]), *static_cast<mud::uvec2*>(args[1]) ); }
...
void Star__construct_1(void* ref, span<void*> args) { new(stl::placeholder(), ref) Star( *static_cast<toy::HSpatial*>(args[0]), *static_cast<Galaxy*>(args[1]), *static_cast<mud::uvec2*>(args[2]), *static_cast<stl::string*>(args[3]) ); }
...
namespace mud
{
	...
	{
		Type& t = type<mud::ComponentHandle<Fleet>>();
		static Meta meta = { t, &namspc({ "mud" }), "ComponentHandle<Fleet>", sizeof(mud::ComponentHandle<Fleet>), TypeClass::Struct };
		// bases
		// defaults
		// constructors
		static Constructor constructors[] = {
			{ t, mud_ComponentHandle_Fleet__construct_0, {} }
		};
		// copy constructor
		static CopyConstructor copy_constructor[] = {
			{ t, mud_ComponentHandle_Fleet__copy_construct }
		};
		// members
		// methods
		// static members
	...
	// mud::ComponentHandle<Galaxy>
	{
		...
		static Meta meta = { t, &namspc({ "mud" }), "ComponentHandle<Galaxy>", sizeof(mud::ComponentHandle<Galaxy>), TypeClass::Struct };
		// bases
		// defaults
		// constructors
		static Constructor constructors[] = {
			{ t, mud_ComponentHandle_Galaxy__construct_0, {} }
		};
		// copy constructor
		static CopyConstructor copy_constructor[] = {
			{ t, mud_ComponentHandle_Galaxy__copy_construct }
		};
		// members
		// methods
		// static members
	...
	{
		Type& t = type<mud::ComponentHandle<Star>>();
		static Meta meta = { t, &namspc({ "mud" }), "ComponentHandle<Star>", sizeof(mud::ComponentHandle<Star>), TypeClass::Struct };
		// bases
		// defaults
		// constructors
		static Constructor constructors[] = {
			{ t, mud_ComponentHandle_Star__construct_0, {} }
		};
		// copy constructor
		static CopyConstructor copy_constructor[] = {
			{ t, mud_ComponentHandle_Star__copy_construct }
		};
		// members
		// methods
		// static members
	...
	// Fleet
	{
		...
		static Constructor constructors[] = {
			...
			{ t, Fleet__construct_1, { { "spatial", type<toy::HSpatial>(),  }, { "galaxy", type<Galaxy>(),  }, { "commander", type<Commander>(),  }, { "coord", type<mud::uvec2>(),  }, { "name", type<stl::string>(),  } } }
		};
		// copy constructor
		// members
		static Member members[] = {
			...
			{ t, offsetof(Fleet, m_coord), type<mud::uvec2>(), "coord", nullptr, Member::Value, nullptr },
			{ t, offsetof(Fleet, m_slot), type<mud::vec3>(), "slot", nullptr, Member::Value, nullptr },
		...
		static Method methods[] = {
			{ t, "order_jump", Address(), Fleet_order_jump, { { "coord", type<mud::uvec2>(),  }, { "stance", type<FleetStance>(),  } }, g_qvoid },
	...
	// Galaxy
	{
		...
		static Constructor constructors[] = {
			...
			{ t, Galaxy__construct_1, { { "spatial", type<toy::HSpatial>(),  }, { "size", type<mud::uvec2>(),  } } }
		};
		// copy constructor
		// members
		static Member members[] = {
	...
	// Jump
	{
		...
		static Member members[] = {
			...
			{ t, offsetof(Jump, m_start), type<mud::uvec2>(), "start", nullptr, Member::Value, nullptr },
			{ t, offsetof(Jump, m_dest), type<mud::uvec2>(), "dest", nullptr, Member::Value, nullptr },
	...
	// Star
	{
		...
		static Constructor constructors[] = {
			{ t, Star__construct_0, {} },
			{ t, Star__construct_1, { { "spatial", type<toy::HSpatial>(),  }, { "galaxy", type<Galaxy>(),  }, { "coord", type<mud::uvec2>(),  }, { "name", type<stl::string>(),  } } }
		};
		// copy constructor
		// members
		static Member members[] = {
			{ t, offsetof(Star, m_galaxy), type<Galaxy>(), "galaxy", nullptr, Member::Flags(Member::Pointer|Member::Link), nullptr },
			{ t, offsetof(Star, m_coord), type<mud::uvec2>(), "coord", nullptr, Member::Value, nullptr },
...
_space::_space()
	: Module("_space", { &mud_infra::m(), &mud_jobs::m(), &mud_type::m(), &mud_tree::m(), &mud_pool::m(), &mud_refl::m(), &mud_ecs::m(), &mud_srlz::m(), &mud_math::m(), &mud_geom::m(), &mud_lang::m(), &mud_ctx::m(), &mud_ui::m(), &mud_uio::m(), &mud_bgfx::m(), &mud_gfx::m(), &mud_gfx_ui::m(), &mud_frame::m(), &toy_util::m(), &toy_core::m(), &toy_visu::m(), &toy_edit::m(), &toy_block::m(), &toy_shell::m() })
{
