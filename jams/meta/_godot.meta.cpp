...
void WorldBlock__construct_0(void* ref, span<void*> args) { UNUSED(args); new(stl::placeholder(), ref) WorldBlock(  ); }
void WorldBlock__construct_1(void* ref, span<void*> args) { new(stl::placeholder(), ref) WorldBlock( *static_cast<toy::HSpatial*>(args[0]), *static_cast<toy::HWorldPage*>(args[1]), *static_cast<toy::HNavblock*>(args[2]), *static_cast<two::vec3*>(args[3]) ); }
...
namespace two
{
	...
	// WorldBlock
	{
		Type& t = type<WorldBlock>();
		static Meta meta = { t, &namspc({}), "WorldBlock", sizeof(WorldBlock), TypeClass::Object };
		// bases
		// defaults
		// constructors
		static Constructor constructors[] = {
			{ t, WorldBlock__construct_0, {} },
			{ t, WorldBlock__construct_1, { { "spatial", type<toy::HSpatial>(),  }, { "world_page", type<toy::HWorldPage>(),  }, { "navblock", type<toy::HNavblock>(),  }, { "extents", type<two::vec3>(),  } } }
		};
		// copy constructor
		// members
		static Member members[] = {
			{ t, offsetof(WorldBlock, m_extents), type<two::vec3>(), "extents", nullptr, Member::Value, nullptr }
		};
		// methods
		// static members
		static Class cls = { t, {}, {}, constructors, {}, members, {}, {}, };
...
_godot::_godot()
	: Module("_godot", { &two_infra::m(), &two_jobs::m(), &two_type::m(), &two_tree::m(), &two_pool::m(), &two_refl::m(), &two_ecs::m(), &two_srlz::m(), &two_math::m(), &two_geom::m(), &two_lang::m(), &two_ctx::m(), &two_ui::m(), &two_uio::m(), &two_bgfx::m(), &two_gfx::m(), &two_gfx_ui::m(), &two_frame::m(), &toy_util::m(), &toy_core::m(), &toy_visu::m(), &toy_edit::m(), &toy_block::m(), &toy_shell::m() })
{
