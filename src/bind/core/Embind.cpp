...
EMSCRIPTEN_BINDINGS(toy_core)
{
    ...
    value_object<toy::Collision>("Collision")
        .field("first", &toy::Collision::first)
        .field("second", &toy::Collision::second)
        .field("hit_point", &toy::Collision::hit_point)
        ;
    ...
    class_<toy::Camera>("Camera")
        ...
        .property("lens_distance", &toy::Camera::lens_distance)
        .property("lens_angle", &toy::Camera::lens_angle)
        .property("near", &toy::Camera::near)
        .property("far", &toy::Camera::far)
        .property("aspect", &toy::Camera::aspect)
        ;
    class_<toy::Collider>("Collider")
        .constructor<>()
        .constructor<toy::HSpatial, toy::HMovable, const toy::CollisionShape&, toy::Medium&, toy::CollisionGroup>()
        .property("spatial", &toy::Collider::spatial)
        .property("movable", &toy::Collider::movable)
        .property("collision_shape", &toy::Collider::collision_shape)
        .property("medium", &toy::Collider::medium)
        .property("group", &toy::Collider::group)
        .property("object", &toy::Collider::object)
    ...
    class_<toy::EntityScript>("EntityScript")
        .constructor<>()
        .constructor<toy::HSpatial>()
        .property("logic_script", &toy::EntityScript::logic_script)
        .property("render_script", &toy::EntityScript::render_script)
        ;
    class_<toy::Medium>("Medium")
        .property("name", &toy::Medium::name)
        .property("occlusions", &toy::Medium::occlusions)
        .property("solid", &toy::Medium::solid)
        ;
    class_<toy::Movable>("Movable")
        .constructor<>()
        .constructor<toy::HSpatial>()
        .property("linear_velocity", &toy::Movable::linear_velocity)
        .property("angular_velocity", &toy::Movable::angular_velocity)
        .property("moving", &toy::Movable::moving)
        .property("previous_position", &toy::Movable::previous_position)
    ...
    class_<toy::Navblock>("Navblock")
        ...
        .property("navmesh", &toy::Navblock::navmesh)
        .property("auto_update", &toy::Navblock::auto_update)
        .property("updated", &toy::Navblock::updated)
        ;
    class_<toy::Navmesh>("Navmesh")
        .constructor<toy::World&>()
        .property("world", &toy::Navmesh::world)
        .property("updated", &toy::Navmesh::updated)
        .property("dirty", &toy::Navmesh::dirty)
        ;
    ...
    class_<toy::PhysicWorld>("PhysicWorld")
        .property("world", &toy::PhysicWorld::world)
    ...
    class_<toy::Solid>("Solid")
        ...
        .property("spatial", &toy::Solid::spatial)
        .property("collider", &toy::Solid::collider)
        .property("static", &toy::Solid::static)
        .property("mass", &toy::Solid::mass)
        ;
    ...
    class_<toy::World>("World")
        ...
        .property("id", &toy::World::id)
        .property("complex", &toy::World::complex)
        .property("name", &toy::World::name)
    ...
    class_<toy::WorldPage>("WorldPage")
        ...
        .property("open", &toy::WorldPage::open)
        .property("extents", &toy::WorldPage::extents)
        .property("world", &toy::WorldPage::world)
        .property("last_rebuilt", &toy::WorldPage::last_rebuilt)
    ...
    class_<toy::DefaultWorld>("DefaultWorld")
        ...
        .property("world", &toy::DefaultWorld::world)
        .property("bullet_world", &toy::DefaultWorld::bullet_world)
        .property("navmesh", &toy::DefaultWorld::navmesh)
        ;
    ...
    class_<toy::Obstacle>("Obstacle")
        ...
        .property("shape", &toy::Obstacle::shape)
        .property("throughput", &toy::Obstacle::throughput)
        ;
    ...
    class_<toy::Spatial>("Spatial")
        ...
        .property("world", &toy::Spatial::world)
        .property("parent", &toy::Spatial::parent)
        .property("contents", &toy::Spatial::contents)
