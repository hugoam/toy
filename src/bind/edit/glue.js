...
function ActionGroup() {
    var self = this.ptr;
    this.ptr = _ActionGroup_ActionGroup_0(self); getCache(ActionGroup)[this.ptr] = this;
};
...
Edit.prototype["__destroy__"] = Edit.prototype.__destroy__ = function() {
    var self = this.ptr;
    _Edit___destroy__(self);
};
// GraphicsDebug
function GraphicsDebug() {
    var self = this.ptr;
    this.ptr = _GraphicsDebug_GraphicsDebug_0(self); getCache(GraphicsDebug)[this.ptr] = this;
};
...
GraphicsDebug.prototype["__destroy__"] = GraphicsDebug.prototype.__destroy__ = function() {
    var self = this.ptr;
    _GraphicsDebug___destroy__(self);
};
// Paste
...
DynamicToolbox.prototype["__destroy__"] = DynamicToolbox.prototype.__destroy__ = function() {
    var self = this.ptr;
    _DynamicToolbox___destroy__(self);
};
// Editor
...
Object.defineProperty(Editor.prototype, "run_game", {
    get: function() {
        var self = this.ptr;
        return !!(_Editor_get_run_game(self));
    },
    set: function(run_game) {
        var self = this.ptr;
        /* run_game <bool> [] */
        _Editor_set_run_game(self, run_game);
    }
});
Object.defineProperty(Editor.prototype, "play_game", {
    get: function() {
        var self = this.ptr;
        return !!(_Editor_get_play_game(self));
    },
    set: function(play_game) {
        var self = this.ptr;
        /* play_game <bool> [] */
        _Editor_set_play_game(self, play_game);
    }
});
Editor.prototype["__destroy__"] = Editor.prototype.__destroy__ = function() {
    var self = this.ptr;
    _Editor___destroy__(self);
};
// PlayTool
