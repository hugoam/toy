...
extern "C" {
	...
	toy::Block* DECL toy_Block__construct_5(mud::ComponentHandle<toy::Spatial>* spatial, mud::ComponentHandle<toy::WorldPage>* world_page, toy::Block* parentblock, size_t index, const mud::vec3* size) {
	...
	mud::ComponentHandle<toy::WorldPage>* DECL toy_Block__get_world_page(toy::Block* self) {
		static mud::ComponentHandle<toy::WorldPage> temp;
		return (temp = self->m_world_page, &temp);
	}
	void DECL toy_Block__set_world_page(toy::Block* self, mud::ComponentHandle<toy::WorldPage>* value) {
	...
	toy::Chunk* DECL toy_Chunk__construct_5(mud::ComponentHandle<toy::Spatial>* spatial, toy::Block* block, size_t index, toy::Element* element, float size) {
	...
	toy::Element* DECL toy_Element__construct_3(const char* name, toy::MatterState state, mud::Colour* colour) {
	...
	toy::Heap* DECL toy_Heap__construct_3(mud::ComponentHandle<toy::Spatial>* spatial, toy::Element* element, float radius) {
	...
	toy::Sector* DECL toy_Sector__construct_5(mud::ComponentHandle<toy::Spatial>* spatial, mud::ComponentHandle<toy::WorldPage>* world_page, mud::ComponentHandle<toy::Navblock>* navblock, const mud::uvec3* coordinate, const mud::vec3* size) {
	...
	toy::Tileblock* DECL toy_Tileblock__construct_6(mud::ComponentHandle<toy::Spatial>* spatial, mud::ComponentHandle<toy::WorldPage>* world_page, mud::ComponentHandle<toy::Navblock>* navblock, const mud::uvec3* size, const mud::vec3* tile_scale, mud::WaveTileset* tileset) {
	...
	mud::ComponentHandle<toy::Tileblock>* DECL toy_generate_block_6(mud::GfxSystem* gfx_system, mud::WaveTileset* tileset, mud::ComponentHandle<toy::Spatial>* origin, const mud::ivec2* coord, const mud::uvec3* block_subdiv, const mud::vec3* tile_scale) {
		static mud::ComponentHandle<toy::Tileblock> temp;
		return (temp = toy::generate_block(*gfx_system, *tileset, *origin, *coord, *block_subdiv, *tile_scale), &temp);
	}
	mud::ComponentHandle<toy::Tileblock>* DECL toy_generate_block_7(mud::GfxSystem* gfx_system, mud::WaveTileset* tileset, mud::ComponentHandle<toy::Spatial>* origin, const mud::ivec2* coord, const mud::uvec3* block_subdiv, const mud::vec3* tile_scale, bool from_file) {
		static mud::ComponentHandle<toy::Tileblock> temp;
