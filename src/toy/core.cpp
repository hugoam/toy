...
{
    // Exported types
    template <> TOY_CORE_EXPORT Type& type<toy::CollisionGroup>() { static Type ty("toy::CollisionGroup", sizeof(toy::CollisionGroup)); return ty; }
    ...
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Camera>>() { static Type ty("ComponentHandle<toy::Camera>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Camera>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Emitter>>() { static Type ty("ComponentHandle<toy::Emitter>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Emitter>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::EntityScript>>() { static Type ty("ComponentHandle<toy::EntityScript>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::EntityScript>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Movable>>() { static Type ty("ComponentHandle<toy::Movable>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Movable>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Navblock>>() { static Type ty("ComponentHandle<toy::Navblock>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Navblock>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Origin>>() { static Type ty("ComponentHandle<toy::Origin>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Origin>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Receptor>>() { static Type ty("ComponentHandle<toy::Receptor>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Receptor>)); return ty; }
    template <> TOY_CORE_EXPORT Type& type<mud::ComponentHandle<toy::Spatial>>() { static Type ty("ComponentHandle<toy::Spatial>", type<mud::Entity>(), sizeof(mud::ComponentHandle<toy::Spatial>)); return ty; }
