...
namespace mud
{
    ...
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::ActionGroup*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Clone*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Cut*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Edit*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::GraphicsDebug*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Paste*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Toolbelt*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Toolbox*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::DynamicToolbox*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::Editor*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::PlayTool*>>();
    export_ template <> TOY_EDIT_EXPORT Type& type<vector<toy::RunTool*>>();
}
