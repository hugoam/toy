...
void toy_Block__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::Block*>(ref))) toy::Block(  ); }
void toy_Block__construct_1(void* ref, array<void*> args) { new(&(*static_cast<toy::Block*>(ref))) toy::Block( *static_cast<toy::HSpatial*>(args[0]), *static_cast<toy::HWorldPage*>(args[1]), static_cast<toy::Block*>(args[2]), *static_cast<size_t*>(args[3]), *static_cast<mud::vec3*>(args[4]) ); }
...
void toy_Chunk__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::Chunk*>(ref))) toy::Chunk(  ); }
void toy_Chunk__construct_1(void* ref, array<void*> args) { new(&(*static_cast<toy::Chunk*>(ref))) toy::Chunk( *static_cast<toy::HSpatial*>(args[0]), *static_cast<toy::Block*>(args[1]), *static_cast<size_t*>(args[2]), *static_cast<toy::Element*>(args[3]), *static_cast<float*>(args[4]) ); }
void toy_Element__construct_0(void* ref, array<void*> args) { new(&(*static_cast<toy::Element*>(ref))) toy::Element( static_cast<const char*>(args[0]), *static_cast<toy::MatterState*>(args[1]), *static_cast<mud::Colour*>(args[2]) ); }
void mud_Grid_toy_Block____construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<mud::Grid<toy::Block*>*>(ref))) mud::Grid<toy::Block*>(  ); }
void mud_Grid_toy_Block____copy_construct(void* ref, void* other) { new(&(*static_cast<mud::Grid<toy::Block*>*>(ref))) mud::Grid<toy::Block*>((*static_cast<mud::Grid<toy::Block*>*>(other))); }
void toy_Heap__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::Heap*>(ref))) toy::Heap(  ); }
void toy_Heap__construct_1(void* ref, array<void*> args) { new(&(*static_cast<toy::Heap*>(ref))) toy::Heap( *static_cast<toy::HSpatial*>(args[0]), *static_cast<toy::Element*>(args[1]), *static_cast<float*>(args[2]) ); }
void toy_Sector__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::Sector*>(ref))) toy::Sector(  ); }
void toy_Sector__construct_1(void* ref, array<void*> args) { new(&(*static_cast<toy::Sector*>(ref))) toy::Sector( *static_cast<toy::HSpatial*>(args[0]), *static_cast<toy::HWorldPage*>(args[1]), *static_cast<toy::HNavblock*>(args[2]), *static_cast<mud::uvec3*>(args[3]), *static_cast<mud::vec3*>(args[4]) ); }
void toy_Tileblock__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::Tileblock*>(ref))) toy::Tileblock(  ); }
void toy_Tileblock__construct_1(void* ref, array<void*> args) { new(&(*static_cast<toy::Tileblock*>(ref))) toy::Tileblock( *static_cast<toy::HSpatial*>(args[0]), *static_cast<toy::HWorldPage*>(args[1]), *static_cast<toy::HNavblock*>(args[2]), *static_cast<mud::uvec3*>(args[3]), *static_cast<mud::vec3*>(args[4]), *static_cast<mud::WaveTileset*>(args[5]) ); }
void mud_ComponentHandle_toy_Block___construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<mud::ComponentHandle<toy::Block>*>(ref))) mud::ComponentHandle<toy::Block>(  ); }
void mud_ComponentHandle_toy_Block___copy_construct(void* ref, void* other) { new(&(*static_cast<mud::ComponentHandle<toy::Block>*>(ref))) mud::ComponentHandle<toy::Block>((*static_cast<mud::ComponentHandle<toy::Block>*>(other))); }
void mud_ComponentHandle_toy_Chunk___construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<mud::ComponentHandle<toy::Chunk>*>(ref))) mud::ComponentHandle<toy::Chunk>(  ); }
void mud_ComponentHandle_toy_Chunk___copy_construct(void* ref, void* other) { new(&(*static_cast<mud::ComponentHandle<toy::Chunk>*>(ref))) mud::ComponentHandle<toy::Chunk>((*static_cast<mud::ComponentHandle<toy::Chunk>*>(other))); }
void mud_ComponentHandle_toy_Heap___construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<mud::ComponentHandle<toy::Heap>*>(ref))) mud::ComponentHandle<toy::Heap>(  ); }
void mud_ComponentHandle_toy_Heap___copy_construct(void* ref, void* other) { new(&(*static_cast<mud::ComponentHandle<toy::Heap>*>(ref))) mud::ComponentHandle<toy::Heap>((*static_cast<mud::ComponentHandle<toy::Heap>*>(other))); }
void mud_ComponentHandle_toy_Sector___construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<mud::ComponentHandle<toy::Sector>*>(ref))) mud::ComponentHandle<toy::Sector>(  ); }
void mud_ComponentHandle_toy_Sector___copy_construct(void* ref, void* other) { new(&(*static_cast<mud::ComponentHandle<toy::Sector>*>(ref))) mud::ComponentHandle<toy::Sector>((*static_cast<mud::ComponentHandle<toy::Sector>*>(other))); }
void mud_ComponentHandle_toy_Tileblock___construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<mud::ComponentHandle<toy::Tileblock>*>(ref))) mud::ComponentHandle<toy::Tileblock>(  ); }
void mud_ComponentHandle_toy_Tileblock___copy_construct(void* ref, void* other) { new(&(*static_cast<mud::ComponentHandle<toy::Tileblock>*>(ref))) mud::ComponentHandle<toy::Tileblock>((*static_cast<mud::ComponentHandle<toy::Tileblock>*>(other))); }
void toy_Earth__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::Earth*>(ref))) toy::Earth(  ); }
