...
void toy_ActionGroup__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::ActionGroup*>(ref))) toy::ActionGroup(  ); }
void toy_ActionGroup__copy_construct(void* ref, void* other) { new(&(*static_cast<toy::ActionGroup*>(ref))) toy::ActionGroup((*static_cast<toy::ActionGroup*>(other))); }
void toy_GraphicsDebug__construct_0(void* ref, array<void*> args) { UNUSED(args); new(&(*static_cast<toy::GraphicsDebug*>(ref))) toy::GraphicsDebug(  ); }
void toy_GraphicsDebug__copy_construct(void* ref, void* other) { new(&(*static_cast<toy::GraphicsDebug*>(ref))) toy::GraphicsDebug((*static_cast<toy::GraphicsDebug*>(other))); }
