...
void toy_GameModule_pump(void* object, span<void*> args, void*& result) { UNUSED(result); (*static_cast<toy::GameModule*>(object)).pump(*static_cast<toy::GameShell*>(args[0]), *static_cast<toy::Game*>(args[1]), *static_cast<mud::Widget*>(args[2])); }
...
void toy_GameModule_paint(void* object, span<void*> args, void*& result) { UNUSED(result); (*static_cast<toy::GameModule*>(object)).paint(*static_cast<toy::GameShell*>(args[0]), *static_cast<toy::GameScene*>(args[1]), *static_cast<mud::Gnode*>(args[2])); }
