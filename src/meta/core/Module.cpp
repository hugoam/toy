...
void toy_CollisionShape__construct_1(void* ref, array<void*> args) { new(stl::placeholder(), &(*static_cast<toy::CollisionShape*>(ref))) toy::CollisionShape( *static_cast<mud::Shape*>(args[0]), *static_cast<mud::vec3*>(args[1]), *static_cast<float*>(args[2]) ); }
...
void mud_OwnedHandle_toy_Collider___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::OwnedHandle<toy::Collider>*>(ref))) mud::OwnedHandle<toy::Collider>(  ); }
void mud_OwnedHandle_toy_Solid___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::OwnedHandle<toy::Solid>*>(ref))) mud::OwnedHandle<toy::Solid>(  ); }
...
void mud_SparseHandle_toy_Collider___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::SparseHandle<toy::Collider>*>(ref))) mud::SparseHandle<toy::Collider>(  ); }
void mud_SparseHandle_toy_Collider___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::SparseHandle<toy::Collider>*>(ref))) mud::SparseHandle<toy::Collider>((*static_cast<mud::SparseHandle<toy::Collider>*>(other))); }
void mud_SparseHandle_toy_Solid___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::SparseHandle<toy::Solid>*>(ref))) mud::SparseHandle<toy::Solid>(  ); }
void mud_SparseHandle_toy_Solid___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::SparseHandle<toy::Solid>*>(ref))) mud::SparseHandle<toy::Solid>((*static_cast<mud::SparseHandle<toy::Solid>*>(other))); }
...
void toy_World__construct_0(void* ref, array<void*> args) { new(stl::placeholder(), &(*static_cast<toy::World*>(ref))) toy::World( *static_cast<uint32_t*>(args[0]), *static_cast<mud::Complex*>(args[1]), *static_cast<string*>(args[2]), *static_cast<mud::JobSystem*>(args[3]) ); }
...
void toy_WorldPage__construct_1(void* ref, array<void*> args) { new(stl::placeholder(), &(*static_cast<toy::WorldPage*>(ref))) toy::WorldPage( *static_cast<toy::HSpatial*>(args[0]), *static_cast<bool*>(args[1]), *static_cast<mud::vec3*>(args[2]) ); }
...
void mud_ComponentHandle_toy_Camera___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Camera>*>(ref))) mud::ComponentHandle<toy::Camera>(  ); }
void mud_ComponentHandle_toy_Camera___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Camera>*>(ref))) mud::ComponentHandle<toy::Camera>((*static_cast<mud::ComponentHandle<toy::Camera>*>(other))); }
void mud_ComponentHandle_toy_Emitter___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Emitter>*>(ref))) mud::ComponentHandle<toy::Emitter>(  ); }
void mud_ComponentHandle_toy_Emitter___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Emitter>*>(ref))) mud::ComponentHandle<toy::Emitter>((*static_cast<mud::ComponentHandle<toy::Emitter>*>(other))); }
void mud_ComponentHandle_toy_EntityScript___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::EntityScript>*>(ref))) mud::ComponentHandle<toy::EntityScript>(  ); }
void mud_ComponentHandle_toy_EntityScript___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::EntityScript>*>(ref))) mud::ComponentHandle<toy::EntityScript>((*static_cast<mud::ComponentHandle<toy::EntityScript>*>(other))); }
void mud_ComponentHandle_toy_Movable___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Movable>*>(ref))) mud::ComponentHandle<toy::Movable>(  ); }
void mud_ComponentHandle_toy_Movable___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Movable>*>(ref))) mud::ComponentHandle<toy::Movable>((*static_cast<mud::ComponentHandle<toy::Movable>*>(other))); }
void mud_ComponentHandle_toy_Navblock___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Navblock>*>(ref))) mud::ComponentHandle<toy::Navblock>(  ); }
void mud_ComponentHandle_toy_Navblock___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Navblock>*>(ref))) mud::ComponentHandle<toy::Navblock>((*static_cast<mud::ComponentHandle<toy::Navblock>*>(other))); }
void mud_ComponentHandle_toy_Origin___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Origin>*>(ref))) mud::ComponentHandle<toy::Origin>(  ); }
void mud_ComponentHandle_toy_Origin___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Origin>*>(ref))) mud::ComponentHandle<toy::Origin>((*static_cast<mud::ComponentHandle<toy::Origin>*>(other))); }
void mud_ComponentHandle_toy_Receptor___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Receptor>*>(ref))) mud::ComponentHandle<toy::Receptor>(  ); }
void mud_ComponentHandle_toy_Receptor___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Receptor>*>(ref))) mud::ComponentHandle<toy::Receptor>((*static_cast<mud::ComponentHandle<toy::Receptor>*>(other))); }
void mud_ComponentHandle_toy_Spatial___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Spatial>*>(ref))) mud::ComponentHandle<toy::Spatial>(  ); }
void mud_ComponentHandle_toy_Spatial___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Spatial>*>(ref))) mud::ComponentHandle<toy::Spatial>((*static_cast<mud::ComponentHandle<toy::Spatial>*>(other))); }
void mud_ComponentHandle_toy_Waypoint___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Waypoint>*>(ref))) mud::ComponentHandle<toy::Waypoint>(  ); }
void mud_ComponentHandle_toy_Waypoint___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::Waypoint>*>(ref))) mud::ComponentHandle<toy::Waypoint>((*static_cast<mud::ComponentHandle<toy::Waypoint>*>(other))); }
void mud_ComponentHandle_toy_WorldPage___construct_0(void* ref, array<void*> args) { UNUSED(args); new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::WorldPage>*>(ref))) mud::ComponentHandle<toy::WorldPage>(  ); }
void mud_ComponentHandle_toy_WorldPage___copy_construct(void* ref, void* other) { new(stl::placeholder(), &(*static_cast<mud::ComponentHandle<toy::WorldPage>*>(ref))) mud::ComponentHandle<toy::WorldPage>((*static_cast<mud::ComponentHandle<toy::WorldPage>*>(other))); }
void toy_DefaultWorld__construct_0(void* ref, array<void*> args) { new(stl::placeholder(), &(*static_cast<toy::DefaultWorld*>(ref))) toy::DefaultWorld( *static_cast<string*>(args[0]), *static_cast<mud::JobSystem*>(args[1]) ); }
...
void toy_Spatial__construct_1(void* ref, array<void*> args) { new(stl::placeholder(), &(*static_cast<toy::Spatial*>(ref))) toy::Spatial( *static_cast<toy::HSpatial*>(args[0]), *static_cast<mud::vec3*>(args[1]), *static_cast<mud::quat*>(args[2]) ); }
void toy_Spatial__construct_2(void* ref, array<void*> args) { new(stl::placeholder(), &(*static_cast<toy::Spatial*>(ref))) toy::Spatial( *static_cast<toy::World*>(args[0]), *static_cast<toy::HSpatial*>(args[1]), *static_cast<mud::vec3*>(args[2]), *static_cast<mud::quat*>(args[3]) ); }
