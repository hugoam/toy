    ...
    // toy::World
    {
        ...
        static Class cls = { type<toy::World>(),
            ...
            // members
            {
                ...
                { type<toy::World>(), member_address<toy::HSpatial(toy::World::*)()>(&toy::World::origin), type<toy::HSpatial>(), "origin", var(toy::HSpatial()), Member::Flags(Member::Value|Member::Structure), [](Ref object) { return Ref(&val<toy::World>(object).origin()); } },
                { type<toy::World>(), member_address<toy::HSpatial(toy::World::*)()>(&toy::World::unworld), type<toy::HSpatial>(), "unworld", var(toy::HSpatial()), Member::Flags(Member::Value|Member::Structure), [](Ref object) { return Ref(&val<toy::World>(object).unworld()); } }
            },
            // methods
            {
            },
