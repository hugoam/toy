...
namespace mud
{
    ...
    template <> TOY_CORE_EXPORT Type& type<toy::DefaultWorld>() { static Type ty("DefaultWorld", sizeof(toy::DefaultWorld)); return ty; }
    ...
    template <> TOY_CORE_EXPORT Type& type<toy::NavmeshShape>() { static Type ty("NavmeshShape", sizeof(toy::NavmeshShape)); return ty; }
    ...
    template <> TOY_CORE_EXPORT Type& type<toy::Spatial>() { static Type ty("Spatial", sizeof(toy::Spatial)); return ty; }
