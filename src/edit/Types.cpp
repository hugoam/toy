...
namespace mud
{
    ...
    template <> TOY_EDIT_EXPORT Type& type<toy::Paste>() { static Type ty("Paste", type<toy::TypedProcedure<toy::Paste>>()); return ty; }
    template <> TOY_EDIT_EXPORT Type& type<toy::Clone>() { static Type ty("Clone", type<toy::TypedProcedure<toy::Clone>>()); return ty; }
    template <> TOY_EDIT_EXPORT Type& type<toy::Edit>() { static Type ty("Edit", type<toy::TypedProcedure<toy::Edit>>()); return ty; }
    template <> TOY_EDIT_EXPORT Type& type<toy::Cut>() { static Type ty("Cut", type<toy::TypedProcedure<toy::Cut>>()); return ty; }
}
